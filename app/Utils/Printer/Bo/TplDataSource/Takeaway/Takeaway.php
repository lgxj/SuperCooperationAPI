...
namespace App\Utils\Printer\Bo\TplDataSource\Takeaway;
...
class Takeaway extends GeneralTplDataSource
{
    public function output($kdtId, $orderNo, $extra)
    {
        ...
        $output['receiptNo'] =$receipt->getReceiptNo($kdtId, "takeaway", $orderNo, time());//小票编号
